...
foreach(X IN LISTS LR11XX_RF_API_SOURCES)
	LIST(APPEND PRECOMPIL_LR11XX_RF_API_SOURCES "${PRECOMPIL_DIR}/${X}")
endforeach()
foreach(X IN LISTS LR11XX_RF_API_HEADERS)
	LIST(APPEND PRECOMPIL_LR11XX_RF_API_HEADERS "${PRECOMPIL_DIR}/${X}")
endforeach()

#Custom command Loop for all RF api Sources and RF api Header
foreach(X IN LISTS LR11XX_RF_API_SOURCES LR11XX_RF_API_HEADERS)
add_custom_command(
...
add_custom_command(OUTPUT ${CMAKE_BINARY_DIR}/defs_rf_api_file
    ...
    COMMAND  cc -E -dMM ${DEF_FLAG_LIST} -I${CMAKE_CURRENT_SOURCE_DIR}/inc -I${CMAKE_SOURCE_DIR}/inc -I${SIGFOX_EP_LIB_DIR}/inc  ${LR11XX_RF_API_HEADERS}  > "${CMAKE_BINARY_DIR}/defs_rf_api_file.tmp"
...
add_custom_target(precompil_${PROJECT_NAME}
	DEPENDS precompil
    DEPENDS ${PRECOMPIL_LR11XX_RF_API_SOURCES}
    DEPENDS ${PRECOMPIL_LR11XX_RF_API_HEADERS}
  	VERBATIM
)
